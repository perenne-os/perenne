...
**Spec:** `docs/superpowers/specs/2026-06-10-phase-2b-memory-design.md`

**Conventions reminder:** commits use the house style (`feat(arch):`, `test:`, `docs:`), no Claude co-author line. Host tests: `cargo test` (whole workspace works on Windows host). Cross-build: `cargo build -p kernel --target riscv64gc-unknown-none-elf`. Integration: `./tools/test-qemu.ps1`.
