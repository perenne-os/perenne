...
- **Commit identity:** project default (no AI co-author; signing automated).
...
- Modify: `docs/design/specs/2026-06-28-phase-16-user-space-nic-design.md` (add an "Implementation note" recording what shipped)
