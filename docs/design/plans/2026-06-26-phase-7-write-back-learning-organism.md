...
**Spec:** `docs/design/specs/2026-06-26-phase-7-write-back-learning-organism-design.md`

## Global Constraints

- **Commits:** Conventional Commits. NO AI co-author trailer. Author identity is Kathir (`kathirpsmy@gmail.com`); signing is automated. (memory: git-commit-conventions)
