...
updated: 2026-06-06
references:
  - "knowledge-base/entries/KB-0002.md (twin issue: SSH push transport)"
...
another developer (or, later, the OS itself) can apply on recurrence. It also
doubles as the schema's worked example (see `knowledge-base/schema/example-0001.md`).
